...
import { StaticDateRangePicker, DateRangeDelimiter, DateRange, LocalizationProvider } from "@material-ui/pickers";
...
export const StaticDateRangePickerFilter: React.FC<any> = (props) => {
