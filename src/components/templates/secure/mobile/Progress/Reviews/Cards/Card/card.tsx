    ...
    return (
        <>
            <ListItem>
                <Link
                    className={s.Link}
                    href={`${pathname}/${props.relatedReview.booking_id}`}
                    ...
                    <ListItemText
                        primary={
                            <>
                                ...
                                >
                                    <div>{BookingReviewStatusesViewSecure[props.relatedReview.status as unknown as keyof typeof BookingReviewStatusesViewSecure]}</div>
                                </Typography>
                        ...
                        secondary={
                            <>
                                <Typography variant="caption">
                                    Создано: {(new Date(props.relatedReview.created_at)).toLocaleDateString("ru", { month: 'short', day: 'numeric' })}
                                </Typography>
                            </>
                        }
                    />
