                    ...
                    <Box sx={{ paddingBottom: '60px' }}>
                        <Stack spacing={2}>
                            ...
                            >
                                ...
                                <Divider />
                                <div>
                                    <div style={{ fontSize: '18px', color: 'black' }}>{arrayStatus[props.item.status]} &#183; {props.item.user?.name}</div>
                        ...
                        <Divider sx={{ borderBottomWidth: 'thick' }} />*/}
                            <Box sx={{ paddingLeft: '20px', paddingRight: '20px' }}>
                                ...
                                <Typography sx={{ fontWeight: 700 }} variant="h5" component="h2" gutterBottom>{props.item.user?.user_profile?.first_name}</Typography>
                                <div>
                                    <div>На kvartiranasutki c {props.item.created_at && dateForViewFormat(props.item.created_at)}</div>
                                </div>
                            </Box>
                            <Divider sx={{ borderBottomWidth: 'thick' }} />
                            <Box sx={{ paddingLeft: '20px', paddingRight: '20px' }}>
                                ...
                                >
                                    ...
                                    <div>
                                        <div>Прибытие</div>
                                        <div style={{ color: "#6b6b6b" }}>{props.item.start_date && dateForViewFormat(props.item.start_date)}</div>
                                    </div>
                                    <Divider />
                                    <div>
                                        <div>Выезд</div>
                                        <div style={{ color: "#6b6b6b" }}>{props.item.end_date && dateForViewFormat(props.item.end_date)}</div>
                                    </div>
                                    <Divider />
                                    <div>
                                        <div>Дата бронирования</div>
                                        <div style={{ color: "#6b6b6b" }}>{props.item.created_at && dateForViewFormat(props.item.created_at)}</div>
                                    </div>
