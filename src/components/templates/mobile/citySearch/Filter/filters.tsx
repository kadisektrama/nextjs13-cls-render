...
import { FormControlLabel, Switch, Typography, Box, Stack, Button, Paper, IconButton } from "@mui/material";
...
export const Filters: React.FC<any> = (props) => {
    ...
    const [amenities, setAmenities] = useState<any>((searchParams.get('filter[amenity]') as string))
    ...
    const [propertyType, setPropertyType] = useState<any>((searchParams.get('filter[property_type]') as string))
