...
export const CommonWithCache: React.FC = () => {
        ...
        <>
            <div>
                <TextField
                    ...
                    label="Название"
                    onBlur={(event: any) => {setName(event.target.value); localStorage.setItem('property[name]', event.target.value)}}
                    style = {{ width: 244 }}
            ...
            <div>
                <StyledTextField
                    ...
                    label="Описание"
                    onBlur={(event: any) => {setDescription(event.target.value); localStorage.setItem('property[description]', event.target.value)}}
                    //style = {{ width: 360 }}
            ...
            <div>
                <Select
                    ...
                    onChange={(value: any) => {setAdType(value); localStorage.setItem('property[ad_type]', value)}}
                    //required
            ...
            <div>
                <Select
                    ...
                    placeholder="Регион *"
                    optionFilterProp="children"
                    onChange={(value: any) => {setRegion(value); localStorage.setItem('property[region]', value)}}
            ...
            <div>
                <TextField
                    ...
                    required
                    label="Улица, дом"
                    onBlur={(event: any) => {setAddress(event.target.value); localStorage.setItem('property[address]', event.target.value)}}
                    style = {{ width: 244 }}
            ...
            <div>
                <TextField
                    ...
                    onBlur={(event: any) => {setAddressSupplement(event.target.value); localStorage.setItem('property[address_supplement]', event.target.value)}}
                    style = {{ width: 244 }}
            ...
            <div>
                <TextField
                    ...
                    label="Цена"
                    onBlur={(event: any) => {setPrice(event.target.value); localStorage.setItem('property[price]', event.target.value)}}
                    style = {{ width: 244 }}
            ...
            <div>
                <TextField
                    ...
                    onBlur={(event: any) => {setRulesDamageDepositAmount(+event.target.value); localStorage.setItem('property[rules.damage_deposit_amount]', event.target.value)}}
                    style = {{ width: 244 }}
                        ...
                        <div style={{ marginTop: '4px' }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', columnGap: '20px' }}>
                                <TextField
                                    ...
                                    label={false}
                                    onBlur={(event: any) => {setRulesDownPaymentAmount(+event.target.value); localStorage.setItem('property[rules.down_payment_amount]', event.target.value)}}
                                    sx={{
                                        '& legend': { display: 'none' },
                                        '& fieldset': { top: 0 },
                                        width: "100px"
            ...
            <div>
                <Select
                    ...
                    onChange={(value: any) => {setCurrency(value); localStorage.setItem('property[currency]', value)}}
                    style = {{ width: 244, borderRadius: '4px' }}
                    //required
            ...
            <div>
                <Select
                    ...
                    onChange={(value: any) => {setPhone(value); localStorage.setItem('property[phone]', value)}}
                    style = {{ width: 244, borderRadius: '4px' }}
                    //required
                    options={state.user.user?.phones}
                />
            </div>
            <div>
                <TextField
                    ...
                    onBlur={(event: any) => {setGuests(event.target.value); localStorage.setItem('property[guests]', event.target.value)}}
                    style = {{ width: 244 }}
            ...
            <div>
                <TextField
                    ...
                    onBlur={(event: any) => {setAdditionalGuests(event.target.value); localStorage.setItem('property[additional_guests]', event.target.value)}}
                    style = {{ width: 244 }}
            ...
            <div>
                <TextField
                    ...
                    name="property[cost_per_additional_guest]"
                    id="property[cost_per_additional_guest]"
                    onBlur={(event: any) => {setCostPerAdditionalGuest(event.target.value); localStorage.setItem('property[cost_per_additional_guest]', event.target.value)}}
                    style = {{ width: 244 }}
                />
            ...
            <div>
                <TextField
                    ...
                    name="property[number_of_bedrooms]"
                    id="property[number_of_bedrooms]"
                    onBlur={(event: any) => {setSummaryBedrooms(event.target.value);localStorage.setItem('property[number_of_bedrooms]', event.target.value)}}
                    style = {{ width: 244 }}
                />
            </div>
            <div>
                <TextField
                    ...
                    name="property[number_of_beds]"
                    id="property[number_of_beds]"
                    onBlur={(event: any) => {setSummaryBeds(event.target.value); localStorage.setItem('property[number_of_beds]', event.target.value)}}
                    style = {{ width: 244 }}
                />
            </div>
            <div>
                <TextField
                    ...
                    id="property[number_of_bathrooms]"
                    onBlur={(event: any) => {setSummaryBathrooms(event.target.value); localStorage.setItem('property[number_of_bathrooms]', event.target.value)}}
                    style = {{ width: 244 }}
                />
            </div>
        </>
